...
"""Minimal Django settings for evennia-effects-conditions unit tests.
...
LOG_DIR = os.path.join(tempfile.gettempdir(), "evennia_effects_conditions_test_logs")
...
DATABASES = {
    "default": {
        ...
        "NAME": ":memory:",
        "TEST": {
            "NAME": "file:evennia_effects_conditions_test_default"
